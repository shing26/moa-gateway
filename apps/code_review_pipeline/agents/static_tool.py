...
def run_ruff_on_files(
    ...
    *,
    ...
    for item in raw_findings:
        ...
        # Make filename relative to repo root by stripping the sandbox prefix
        # The sandbox is a temp dir; the files were written using their relative paths.
        # We keep only the relative path portion.
        try:
        ...
        # Map ruff severity: ruff itself does not emit severity.
        # We derive a rough one from rule category.
